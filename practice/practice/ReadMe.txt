...
practiceDlg.h, practiceDlg.cpp - 대화 상자
    이 파일에는 CpracticeDlg 클래스가 포함됩니다. 이 클래스는 응용 프로그램의 주 대화 상자에 대한 동작을 정의합니다. 이 대화 상자 템플릿은 practice.rc에 있으며, Microsoft Visual C++에서 직접 편집할 수 있습니다.
