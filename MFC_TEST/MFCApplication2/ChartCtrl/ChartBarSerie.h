...
public:
	...
	**/
	...
	/*static */void SetInterSpace(int Space)	{ m_iInterSpace = Space; }	// LIMJI 수정
	//! Static function returning the space between series of the same group.
	/*static */int  GetInterSpace()				{ return m_iInterSpace;  }	// LIMJI 수정
...
private:
	...
	**/
	...
	/*static */int m_iInterSpace;	// LIMJI 수정
	//! List of all bar series added to the control
	/*static TBarSeriesList m_lstBarSeries;*/
	std::list<CChartBarSerie*> CChartBarSerie::m_lstBarSeries;// LIMJI 수정
